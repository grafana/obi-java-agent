...
class SSLStorageTest {
    ...
    void testSessionConnectionMapping() throws Exception {
        ...
        Connection conn = new Connection(InetAddress.getByName("127.0.0.1"), 1234, InetAddress.getByName("1.2.3.4"),
                5678);
    ...
    void testBufConnectionMapping() throws Exception {
        ...
        Connection conn = new Connection(InetAddress.getByName("127.0.0.2"), 4321, InetAddress.getByName("5.6.7.8"),
                8765);
    ...
    void testActiveConnectionTracking() throws Exception {
        Connection conn = new Connection(InetAddress.getByName("127.0.0.3"), 1111, InetAddress.getByName("8.8.8.8"),
                2222);
    ...
    void testCleanupConnectionBufMapping() throws Exception {
        String bufKey = "bufY";
        Connection conn = new Connection(InetAddress.getByName("127.0.0.4"), 3333, InetAddress.getByName("9.9.9.9"),
                4444);
